					...
					<div class="item active">
						...
						<div class="slider-content">
							<div class="col-md-12 text-center">
								<h2 class="animated2">
									<span>Welcome to <strong>Public</strong></span>
								</h2>
								<h3 class="animated3">
							...
							<div class="col-md-12 text-center">
								...
								<div class="">
									<a
										...
										href="#">Get Now</a><a
										class="animated4 slider btn btn-default btn-min-block"
										href="#">Live Demo</a>
								</div>
							</div>
						</div>
				...
				<div class="container">
					...
					<p class="text-center">
						...
						accusantium <span class="accent-color sh-tooltip"
							...
							laudantium</span>, totam rem aperiam, eaque ipsa quae ab illo inventore
						<br />veritatis et quasi <span class="accent-color sh-tooltip"
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-3 col-md-3">
									<div class="counter-item">
										...
										<div class="timer" id="item3" data-to="18745"
											data-speed="5000"></div>
